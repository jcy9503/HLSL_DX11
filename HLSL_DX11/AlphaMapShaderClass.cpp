...
{
    WCHAR vsFile[] = L"../HLSL_DX11/AlphamapShader/Alphamap.vs";
    WCHAR psFile[] = L"../HLSL_DX11/AlphamapShader/Alphamap.ps";
...
bool AlphaMapShaderClass::Render(ID3D11DeviceContext* deviceContext, const int indexCount, const XMMATRIX worldMatrix,
...
bool AlphaMapShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
    ...
    HRESULT result = D3DCompileFromFile(vsFilename, nullptr, nullptr, "AlphaMapVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
    ...
    result = D3DCompileFromFile(psFilename, nullptr, nullptr, "AlphaMapPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
...
void AlphaMapShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, const HWND hwnd, const WCHAR* shaderFilename)
{
...
void AlphaMapShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, const int indexCount) const
{
