...
{
    constexpr WCHAR vsFile[] = L"../HLSL_DX11/BumpmapShader/Bumpmap.vs";
    constexpr WCHAR psFile[] = L"../HLSL_DX11/BumpmapShader/Bumpmap.ps";
...
bool BumpmapShaderClass::Render(ID3D11DeviceContext* deviceContext, const int indexCount, const XMMATRIX worldMatrix,
                                const XMMATRIX viewMatrix, const XMMATRIX projectionMatrix, ID3D11ShaderResourceView** textureArray,
                                const XMFLOAT3 lightDirection, const XMFLOAT4 diffuseColor) const
{
...
bool BumpmapShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, const WCHAR* vsFilename, const WCHAR* psFilename)
{
    ...
    HRESULT result = D3DCompileFromFile(vsFilename, nullptr, nullptr, "BumpmapVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
    ...
    result = D3DCompileFromFile(psFilename, nullptr, nullptr, "BumpmapPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
...
void BumpmapShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, const HWND hwnd, const WCHAR* shaderFilename)
{
...
void BumpmapShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, const int indexCount) const
{
